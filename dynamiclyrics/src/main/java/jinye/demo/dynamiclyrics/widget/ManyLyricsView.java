package jinye.demo.dynamiclyrics.widget;
...
import jinye.demo.dynamiclyrics.utils.StringUtils;
import jinye.demo.dynamiclyrics.utils.TimeUtils;
...
public class ManyLyricsView extends AbstractLrcView {
  ...
  /*是否允许松开后继续滑动*/
  private boolean mIsAllowLooseSliding = false;
  /**
   * 播放按钮区域字体大小
   */
   ...
   * @param context
   */
  private OnScrollingTouchListener mOnScrollingTouchListener;
  ...
  public void setmIsAllowLooseSliding(boolean mIsAllowLooseSliding) {
    this.mIsAllowLooseSliding = mIsAllowLooseSliding;
  }

  public boolean getIsAllowLooseSliding() {
    return mIsAllowLooseSliding;
  }
  ...
  public boolean onTouchEvent(MotionEvent event) {
    ...
    switch (actionId) {
      case MotionEvent.ACTION_DOWN:
        ...
        if (mOnScrollingTouchListener != null) {
          mOnScrollingTouchListener.toolDown();
        }
        break;
...
//      Log.e("文本数据", mWordsDisInterval.length + "");
   ...
   * 以时间控制
   */
  public void toolSetSpeed(int mTime) {
    this.mPlaySpeed = mTime;
  }

  public int getmPlaySpeed() {
    return mPlaySpeed;
  }
   ...
   * 设置动感文本数据
   */
  public void toolSetData(String mData, String mRegular, boolean mIsRegular) {
    this.mOriginalText = mData;
    this.mRegular = mRegular;
    this.mIsRegular = mIsRegular;
    /*为String 拆分*/
    /*首先计算一个文字有多宽 Paint*/
    /*然后获取控件宽/这里是屏幕宽*/
   ...
   * 设置滑动松开事件
   */
  public void toolSetScrollTouchListener(OnScrollingTouchListener mOnScrollingTouchListener) {
    this.mOnScrollingTouchListener = mOnScrollingTouchListener;
  }
   ...
   * 一些控制
   */
  public interface OnScrollingTouchListener {

    void toolBuildDataEnd();
